...
public class JwtService {
    ...
    public String generateAccessToken(CustomUserDetails userDetails) {
        ...
        return generateToken(userDetails, extraClaims, appProperties.security().jwt().accessTokenTtl().toMillis());
    }

    public String generateRefreshToken(UserDetails userDetails) {
        return generateToken(userDetails, new HashMap<>(), appProperties.security().jwt().refreshTokenTtl().toMillis());
    }
    ...
    private String generateToken(UserDetails userDetails, HashMap<String, Object> extraClaims, long expiration) {
        return Jwts.builder()
                .claims(extraClaims)
                .id(TokenGenerator.generateJti())    // jti
